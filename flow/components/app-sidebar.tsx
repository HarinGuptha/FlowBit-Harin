...
export function AppSidebar({ selectedFolder, onFolderSelect, onManageFolders, folders }: AppSidebarProps) {
  ...
  // Mock data for workflows in each folder - Updated with LangFlow agents
  const mockWorkflows = {
    unassigned: [
      { id: "classifier", name: "Classifier Agent", engine: "langflow" },
      { id: "email", name: "Email Agent", engine: "langflow" },
      { id: "json", name: "JSON Agent", engine: "langflow" },
      { id: "pdf", name: "PDF Agent", engine: "langflow" },
    ],
    marketing: [
